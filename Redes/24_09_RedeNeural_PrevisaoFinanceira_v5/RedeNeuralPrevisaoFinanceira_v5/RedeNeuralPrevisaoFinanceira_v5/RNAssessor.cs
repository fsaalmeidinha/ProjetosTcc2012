...
namespace RedeNeuralPrevisaoFinanceira_v5
{
    public class RNAssessor
    {
        ...
        //private static double versao = 5.01;
        //private static double versao = 5.02;
        //private static double versao = 5.03;
        //private static double versao = 5.04;
        //private static double versao = 5.05;
        //private static double versao = 5.06;
        //private static double versao = 5.07;
        //private static double versao = 5.08;
        //RECALCULAR//////private static double versao = 5.09;
        ...
        private static string diretorioRedes
        {
            get
            {
                return ConfigurationManager.AppSettings["DiretorioRedes_v5"] + "\\RedesPrevisaoFinanceira\\";
            }
        }
        private static string diretorioCrossValidation
        {
            get
            {
                return ConfigurationManager.AppSettings["DiretorioRedes_v5"] + "\\RelatorioCrossValidation\\";
            }
        }
        ...
        private string TreinarRedeNeural(string papel, int nn, double ta, int ct, List<DadosBE> dadosBE, int shift)
        {
            ...
            RedeNeural_v5.Treinar(papel, nomeRede, dadosBE, nn, ta, ct, numeroDivisoesCrossValidation, shift, versao);
            return nomeRede;
        }
        ...
        public static List<double[]> PreverCotacao(DateTime dtPrevisao, double versaoRN, int qtdDiasPrevisao, string papel = "PETR4")
        {
            ...
            DataBaseUtils.DataBaseUtils.PreencherIndicesRN_V5(dadosBE, versao);
            ...
            for (int indPrevisao = 0; indPrevisao < qtdDiasPrevisao; indPrevisao++)
            {
                ...
                List<double> input = DataBaseUtils.DataBaseUtils.TransformarDadoBE_Em_Treinamento_RNV5(dadoBE, versao).Input;
